...
**Место:** `src/v2/store.ts:34–52`, чтение и объединение настроек до блокировки поставщика.
...
**Место:** `mvp/src/components/GlobalNewsV2.tsx:69`, `:125`, `:130` — остановка опроса, приём старого ответа и неполный сброс при изменении подключений.
...
**Место:** `src/v2/providers/paid.ts:178–183` и `src/v2/worker.ts:88`.
...
**Место:** `src/v2/store.ts:185–192`; формирование удаления без времени обновления — `src/v2/providers/paid.ts:114–117`.
...
**Место:** `mvp/src/app/api/reader/[namespace]/[id]/route.ts:7–8`; проверка окружения — `mvp/src/lib/news-v2.ts:14–15`.
...
**Место:** `src/v2/store.ts:186`, `:195–198`.
...
**Место:** `src/v2/providers/sec.ts:95–107` и последующее сохранение статьи.
...
**Место:** `src/v2/providers/paid.ts:60–83`.
...
**Место:** `src/providers/marketaux.ts:178–203`, `:273–285`.
