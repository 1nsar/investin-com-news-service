...
`polymarket-evidence/2026-09-08/`. Для каждого запроса сохранены URL, HTTP-статус,
...
1. Локальные материалы проверки. [Исходный журнал запросов](polymarket-evidence/2026-09-08/manifest.json).
...
15. Локальные материалы проверки. [Журнал браузерной проверки](polymarket-evidence/2026-09-09/mvp-validation.json).
16. Локальные материалы проверки. [Нормализованный локальный ответ](polymarket-evidence/2026-09-09/mvp-market.json).
17. Локальные материалы проверки. [Метаданные и хеши снимков](polymarket-evidence/2026-09-08/screenshots.json).
...
[^1]: [Исходный журнал запросов](polymarket-evidence/2026-09-08/manifest.json).
...
[^15]: [Журнал браузерной проверки](polymarket-evidence/2026-09-09/mvp-validation.json).
[^16]: [Нормализованный локальный ответ](polymarket-evidence/2026-09-09/mvp-market.json).
[^17]: [Метаданные и хеши снимков](polymarket-evidence/2026-09-08/screenshots.json).
