...
`polymarket-evidence/2026-09-08/`. Each manifest entry records its URL, HTTP status,
...
1. Local validation evidence. [Original request manifest](polymarket-evidence/2026-09-08/manifest.json).
...
15. Local validation evidence. [Recorded browser checks](polymarket-evidence/2026-09-09/mvp-validation.json).
16. Local validation evidence. [Local normalized response](polymarket-evidence/2026-09-09/mvp-market.json).
17. Local validation evidence. [Screenshot metadata and hashes](polymarket-evidence/2026-09-08/screenshots.json).
...
[^1]: [Original request manifest](polymarket-evidence/2026-09-08/manifest.json).
...
[^15]: [Recorded browser checks](polymarket-evidence/2026-09-09/mvp-validation.json).
[^16]: [Local normalized response](polymarket-evidence/2026-09-09/mvp-market.json).
[^17]: [Screenshot metadata and hashes](polymarket-evidence/2026-09-08/screenshots.json).
