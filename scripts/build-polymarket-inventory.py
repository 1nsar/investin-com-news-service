...
DOCS = ROOT / 'docs'
EVIDENCE = DOCS / 'polymarket-evidence' / '2026-09-08'
MVP_EVIDENCE = DOCS / 'polymarket-evidence' / '2026-09-09'
...
workbook=xlsxwriter.Workbook(DOCS/'Polymarket-Data-Inventory.xlsx',{'strings_to_formulas':False,'strings_to_urls':False})
...
print('Built docs/Polymarket-Data-Inventory.xlsx and chart; no network requests.')
