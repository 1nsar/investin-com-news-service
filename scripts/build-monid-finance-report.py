...
DOCS = ROOT / 'docs'
EVIDENCE = DOCS / 'monid-finance-evidence/2026-09-09'
...
(DOCS/'MONID-FINANCE-TOOLS-REPORT.md').write_text('\n'.join(line.rstrip() for line in md.splitlines())+'\n')
...
with (DOCS/'monid-finance-tool-inventory.csv').open('w',newline='') as f:
...
wb=xlsxwriter.Workbook(str(DOCS/'Monid-Finance-Tools-Report.xlsx'))
