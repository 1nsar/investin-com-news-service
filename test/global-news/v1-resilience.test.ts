...
import { MarketauxProvider } from "../../src/features/global-news/providers/marketaux.js";
import { startScheduler, stopScheduler } from "../../src/features/global-news/ingest/scheduler.js";
import { runIngestExclusive } from "../../src/features/global-news/ingest/runner.js";
import type { FetchableCompany } from "../../src/features/global-news/providers/types.js";
...
vi.mock("../../src/features/global-news/ingest/runner.js",()=>({runIngestExclusive:vi.fn().mockResolvedValue({})}));
