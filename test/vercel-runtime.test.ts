...
import { ingestInProgress, runIngestExclusive } from "../src/ingest/runner.js";
import { fetchProviderBatch } from "../src/v2/providers/index.js";
import { startV2Worker, stopV2Worker, workerEnabled } from "../src/v2/worker.js";
...
vi.mock("../src/v2/providers/index.js", async (importOriginal) => ({
  ...await importOriginal<typeof import("../src/v2/providers/index.js")>(),
