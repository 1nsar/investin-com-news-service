/** Run NEWS_V2_TEST_DB=1 node --import dotenv/config node_modules/vitest/vitest.mjs run test/v2-db.test.ts.
...
import { definitionFor, deleteProvider, persistArticles, providerStatuses, resolveCompany, updateProvider } from "../src/v2/store.js";
import { readArticle, readNews } from "../src/v2/read.js";
